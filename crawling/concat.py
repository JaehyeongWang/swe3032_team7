...
def concat_file(folder_name, file_name): #file_name contains .csv
    origin_folder_path = f'../data/{folder_name}'
    search_folder_path = f'./{folder_name}_search'

    file = file_name

    origin_file_path = os.path.join(origin_folder_path, file)
    search_file_path = os.path.join(search_folder_path, file)
